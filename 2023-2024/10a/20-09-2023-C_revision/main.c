...
// при компилиране подаваме и файлва с реалната имплементация
#include "foo.h"
...
int main()
{
    ...
    printf("%d\n", arrP[1]); // не гарантирано, че е нуло, може да е garbage стойност
    printf("%d\n", arrC[1]); // 0 съсигурност

    // при реалокиране е добра практика да се използва временен указел в случай, че realloc върне грешка.
